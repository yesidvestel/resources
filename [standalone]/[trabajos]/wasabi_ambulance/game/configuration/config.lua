...
Config.DamageDetectThreshold = {
    armour = 5,
    health = 10
} -- Damage threshold to detect injury (Default: {armour = 5, health = 10})
...
WEAPON_UNARMED, WEAPON_STUNGUN, WEAPON_DROWNING, WEAPON_DROWNING_IN_VEHICLE --  `WEAPON_FALL`,
}
...
Config.PainPills =
    { -- Add more as you please. The level field simulates the severity of the narcodic; exceed 10 and it could be deadly
...
Config.CompleteDeath =
    { -- DOES NOT APPLY TO QBCORE --  When enabled players can no longer use their character after x deaths
...
Config.StandaloneCheckIns = {
    ...
    Prison = { -- Example, QB Prison check-in
        ...
        RespawnNoBedLocation = {
            coords = vec3(1729.03, 2563.33, 45.56),
            heading = 339.02
        }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds full
        HospitalBeds = { --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
        {
            coords = vec3(317.67, -585.37, 42.84 + 0.3),
            heading = 160.0
        }}
    }
...
Config.Locations = {
    Pillbox = {
        ...
        CheckIn = { -- Hospital check-in
            ...
            RespawnNoBedLocation = {
                coords = vec3(316.66, -581.3, 43.28),
                heading = 339.02
            }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds are full
            HospitalBeds = { --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
            {
                coords = vec3(318.04, -572.2, 48.12 + 0.3),
                heading = 160.0
            }, {
                coords = vec3(316.8, -566.48, 49.12 + 0.3),
                heading = 340.0
            }, {
                coords = vec3(323.35, -568.81, 49.12 + 0.3),
                heading = 160.0
        ...
        Cloakroom = {
            ...
            Uniforms = { -- Uniform choices
                [1] = { -- Order it will display
                    ...
                    male = { -- Male variation
                        clothing = { -- Components / 0: Face 1: Mask 2: Hair 3: Torso 4: Leg 5: Parachute / bag 6: Shoes 7: Accessory 8: Undershirt 9: Kevlar 10: Badge 11: Torso 2
        ...
        MedicalSupplies = { -- EMS Shop for supplies
            ...
            Supplies = { -- Supplies
            {
                ...
                label = 'Bolsa Médica',
                price = 1000
            }, -- Bastante autoexplicativo, el precio puede ser 'false' para hacerlo gratuito
            {
                item = 'medikit',
        ...
        Vehicles = { -- Vehicle Garage
            ...
            Options = {
                [0] = { -- Job grade as table name
                    ['amrvan'] = { -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Ambulancia',
                    ...
                    ['RoyalYamahaEMS_white'] = { -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Moto',
                        category = 'land' -- Options are 'land' and 'air'
                    }
                },

...
Config.Items = {
	...
	[4] = { name = "weapon_flashlight", price = 300, amount = 100, info = {}, type = "item", slot = 4, }, 
	[5] = { name = "handdrill",	price = 100, amount = 100, info = {}, type = "item", slot = 5, },
	[6] = { name = "drillbit", price = 100, amount = 100,	info = {}, type = "item", slot = 6, }, }		
}
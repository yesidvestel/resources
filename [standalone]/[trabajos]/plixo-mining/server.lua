...
RegisterServerEvent('row-mining:MineReward')
AddEventHandler('row-mining:MineReward', function()
...
RegisterServerEvent('row-mining:CrackReward')
AddEventHandler('row-mining:CrackReward', function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("row-mining:Selling")
AddEventHandler("row-mining:Selling", function(data)
    local src = source
    ...
    if Player.Functions.GetItemByName(data) ~= nil then
        ...
        TriggerClientEvent("QBCore:Notify", src, "Never on"..QBCore.Shared.Items[data].label.." None", "error")
    end
    Citizen.Wait(1000)
end)

RegisterNetEvent("row-mining:SellJewel")
AddEventHandler("row-mining:SellJewel", function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local currentitem = data
    if Player.Functions.GetItemByName(data) ~= nil then
...
QBCore.Functions.CreateCallback('row-mining:Smelting:Check:1', function(source, cb)
	local src = source
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Smelting:Check:2', function(source, cb)
	local src = source
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Smelting:Check:3', function(source, cb)
	local src = source
    local Player = QBCore.Functions.GetPlayer(source) 
...
QBCore.Functions.CreateCallback('row-mining:Smelting:Check:4', function(source, cb)
	local src = source
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Smelting:Check:5', function(source, cb)
	local src = source
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Smelting:Check:6', function(source, cb)
	local src = source
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterServerEvent('row-mining:Smelting:Reward')
AddEventHandler('row-mining:Smelting:Reward', function(data)
    local src = source
	local Player = QBCore.Functions.GetPlayer(source)
	if data == 1 then
		...
		Player.Functions.AddItem("copper", 10, false, {["quality"] = nil})
	...
	elseif data == 3 then
		...
		Player.Functions.AddItem("iron", 10, false, {["quality"] = nil})
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:Tools', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:1', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:2', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:3', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:4', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:5', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:6', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:7', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:8', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:9', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:10', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemByName('goldbar') ~= nil then
		cb(true)
	else 
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:11', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemByName('goldbar') ~= nil then
		cb(true)
	else 
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:12', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:13', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:14', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('row-mining:Cutting:Check:15', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterServerEvent('row-mining:Cutting:Reward')
AddEventHandler('row-mining:Cutting:Reward', function(data)
    local src = source
	local Player = QBCore.Functions.GetPlayer(source)
	...
	elseif data == 11 then
		Player.Functions.RemoveItem('goldbar', 1)
		TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items['goldbar'], 'remove', 1)
		Player.Functions.AddItem("10kgoldchain", 2, false, {["quality"] = nil})

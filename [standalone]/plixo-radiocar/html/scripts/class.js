...
$( "#playSong" ).click(function()
{
    ...
    updateName($("#url").val());
    $.post('https://plixo-radiocar/play', JSON.stringify(
    {
        url: $("#url").val(),
    }));
});
...
$( "#buttonOff" ).click(function()
{
	...
	$("#nameSong").text(locales.nameSong);
	$("#timeSong").text(locales.timeSong.format("00:00:00"))
    $.post('https://plixo-radiocar/stop', JSON.stringify({}));
});

$( "#volumeup" ).click(function()
{
    $.post('https://plixo-radiocar/volumeup', JSON.stringify({}));
});

$( "#volumedown" ).click(function()
{
    $.post('https://plixo-radiocar/volumedown', JSON.stringify({}));
});
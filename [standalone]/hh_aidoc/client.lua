...
function DoctorNPC()
	...
	QBCore.Functions.Progressbar("revive_doc", "El doctor te está dando ayuda médica.", Config.ReviveTime, false, false, {
		...
		Notify("Tu tratamiento está hecho, te cobraron: "..Config.Price, "success")
		--local xPlayer = QBCore.Functions.GetPlayer(source)
		--xPlayer.Functions.RemoveMoney('cash', 200, 'Pago anuncio')

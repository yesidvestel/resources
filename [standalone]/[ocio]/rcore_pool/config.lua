Config = {
    ...
    Text = {
        ...
        POOL = 'Pool Menu',
        POOL_GAME = 'Pool game',
        POOL_SUBMENU = 'Select an option',
        TYPE_8_BALL = '8-Ball',
        TYPE_STRAIGHT = 'Straight pool',

        HINT_SETUP = 'Prepare the table',
        HINT_TAKE_CUE = 'Take a cue',
        HINT_RETURN_CUE = 'Put cue back',
        HINT_HINT_TAKE_CUE = 'Grab a cue first to play',
        HINT_PLAY = 'Play',
        ...
        BALL_POCKETED = 'Ball in hole',
        BALL_IN_HAND_NOTIFY = 'You Got the ball in',
        BALL_LABELS = {
            [-1] = 'Cue',
            [1] = '~y~Solid 1~s~',
            [2] = '~b~Solid 2~s~',

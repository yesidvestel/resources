...
Config.DoorList = {
	...
	},
	{
		...
		objCoords = vec3(410.11, -1022.21, 28.28),
		textCoords = vec3(410.11, -1022.21, 28.28),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		autoLock = 2000,
	...
	-- gang
	{
		...
		objCoords  = vec3(79.69, -1959.93, 20.9),
		textCoords = vec3(79.69, -1959.93, 20.9),
	...
	},
	{
		...
		objCoords  = vec3(86.66, -1959.48, 21.22),
		textCoords = vec3(86.66, -1959.48, 21.22),
		authorizedGangs = { 'ballas' },
		objYaw = 90.0,
		locked = true,
		pickable = false,
	...
	{
		objName = 'v_ilev_mm_door',
		objCoords  = vec3(83.55, -1967.05, 21.08),
		textCoords = vec3(83.55, -1967.05, 21.08),
		authorizedGangs = { 'ballas' },
		objYaw = 90.0,
		locked = true,
		pickable = false,

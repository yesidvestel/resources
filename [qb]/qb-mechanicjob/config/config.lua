...
Config.Shops = {
    mechanic = { -- City location
        ...
        shop = vector3(-1150.18, -1727.27, 5.1), -- Tienda mecanico
        duty = vector3(-1140.12, -1717.22, 4.9),  --Entrar y salir de servicio
        stash = vector3(-1144.77, -1717.49, 4.9), -- Almacenamiento
        paint = vector3(-1140.62, -1722.58, 4.99), -- Pintar carros
        vehicles = {
            withdraw = vector3(-1132.86, -1726.55, 4.9),
            spawn = vector4(-1130.24, -1719.29, 4.28, 207.22),

...
Config.DefaultSpawn = vector3(-1037.75, -2737.85, 20.17) -- Default spawn coords if you have start apartments disabled
...
Config.PlayersNumberOfCharacters = { -- Define maximum amount of player characters by rockstar license (you can find this license in your server's database in the player table)
    { license = "license:141d890765d2711fc128d4e2f06baf32c7faa8c7", numberOfChars = 2 },
    { license = "license:301ae3559b4170dc213c2cca929fe42482657cc7", numberOfChars = 2 },
}

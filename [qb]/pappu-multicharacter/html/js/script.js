...
function setCharactersList(max) {
    ...
    for (let i = 1; i <= max+1; i++) {
        htmlResult += '<div class="character" id="char-'+ i +'" data-cid=""><div class="character-div"><div class="user2"></div><span id="slot-name">'+translations["create_new_character"]+'<span id="cid"></span></span><div class="user2"></div></div><div class="btns" style=""> <div class="character-btn" id="select" style="display: block;"><p id="select-text"><i "="">'+translations["select"]+'</i></p></div> </div> </div>'
    }
    htmlResult += '</div>'

...
function QBCore.Player.CreatePlayer(PlayerData, Offline)
    ...
    function self.Functions.ChangeIban(iban)
    ...
    function self.Functions.AddMoney(moneytype, amount, reason)
		...
		if moneytype == 'cash' and reason ~= 'iscash' then
            ...
            if exports['qb-inventory']:HasItem(source,'cash') then
                ...
                exports['qb-inventory']:AddItem(source,'cash',amount,slots[1],'iscash')
            else
            ...
            if exports['qb-inventory']:HasItem(source,'cash') then
                ...
                if totalmoney >= amount then
                    ...
                    for k,v in pairs(slots) do
                        ...
                        exports['qb-inventory']:RemoveItem(source,'cash',toRemove,slots[k],'iscash')

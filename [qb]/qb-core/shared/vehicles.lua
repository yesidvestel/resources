...
local Vehicles = {
    ...
    -- Concesionario 
    -- Audi
    { model = 'aaq4',        name = 'Audi A4',                        brand = 'Audi',           price = 21000,   category = 'audi',           type = 'automobile', shop = 'conce', tier = 'C'}, 
    { model = 'rs6rabt20',   name = 'Audi RS6 ABT 2020',              brand = 'Audi',           price = 39000,   category = 'audi',           type = 'automobile', shop = 'conce', tier = 'A' },
    { model = 'rs7',         name = 'Audi RS7',                       brand = 'Audi',           price = 32000,   category = 'audi',           type = 'automobile', shop = 'conce', tier = 'A+' },
    { model = 'rs615',       name = 'Audi RS6 Patrol',                brand = 'Audi',           price = 28000,   category = 'audi',           type = 'automobile', shop = 'conce', tier = 'S' },
    { model = 's8d4',        name = 'Audi S8 D4',                     brand = 'Audi',           price = 30000,   category = 'audi',           type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = '18rs7',       name = 'Audi RS7 2018',                  brand = 'Audi',           price = 29000,   category = 'audi',           type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'mansrs6',     name = 'Mansory Audi RS6',               brand = 'Audi',           price = 35000,   category = 'audi',           type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'Hycaders6',   name = 'Hyundai RS6',                    brand = 'Audi',           price = 33000,   category = 'audi',           type = 'automobile', shop = 'conce', tier = 'S+' },

    -- Bentley
    { model = 'contgt2011',  name = 'Bentley Continental GT 2011',    brand = 'Bentley',        price = 60000,   category = 'bentley',        type = 'automobile', shop = 'conce', tier = 'B' },
    { model = 'bentaygam',   name = 'Bentley Bentayga',               brand = 'Bentley',        price = 80000,   category = 'bentley',        type = 'automobile', shop = 'conce', tier = 'S+' },

    -- Ferrari
    { model = '488',         name = 'Ferrari 488',                    brand = 'Ferrari',        price = 90000,   category = 'ferrari',        type = 'automobile', shop = 'conce', tier = 'C'}, 
    { model = 'f812',        name = 'Ferrari 812 Superfast',          brand = 'Ferrari',        price = 150000,  category = 'ferrari',        type = 'automobile', shop = 'conce', tier = 'A+' },
    { model = 'fxxk',        name = 'Ferrari FXX K',                  brand = 'Ferrari',        price = 120000,  category = 'ferrari',        type = 'automobile', shop = 'conce', tier = 'S+' },

    -- Ford/Mustang
    { model = 'boss429',     name = 'Mustang Boss 429',               brand = 'Ford',           price = 25000,   category = 'ford',           type = 'automobile', shop = 'conce', tier = 'B' },
    { model = 'eleanor',     name = 'Shelby GT500 Eleanor',           brand = 'Ford',           price = 24000,   category = 'ford',           type = 'automobile', shop = 'conce', tier = 'A' },
    { model = 'fgt',         name = 'Ford GT',                        brand = 'Ford',           price = 50000,   category = 'ford',           type = 'automobile', shop = 'conce', tier = 'S' },
    { model = 'mach1',       name = 'Ford Mustang Mach 1',            brand = 'Ford',           price = 35000,   category = 'ford',           type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'rapger19',    name = 'Ford Raptor 2019',               brand = 'Ford',           price = 32000,   category = 'ford',           type = 'automobile', shop = 'conce', tier = 'S+' },

    -- McLaren
    { model = '675lt',       name = 'McLaren 675LT',                  brand = 'McLaren',        price = 120000,  category = 'mclaren',        type = 'automobile', shop = 'conce', tier = 'C'}, 
    { model = 'mlnovitec',   name = 'McLaren Novitec',                brand = 'McLaren',        price = 180000,  category = 'mclaren',        type = 'automobile', shop = 'conce', tier = 'B' },

    -- Mercedes-Benz
    { model = 'a45',         name = 'Mercedes A45',                   brand = 'Mercedes-Benz',  price = 21000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'C'}, 
    { model = 'amggt16',     name = 'Mercedes AMG GT 2016',           brand = 'Mercedes-Benz',  price = 80000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'B' },
    { model = '2020CLA45s',  name = 'Mercedes CLA 45S 2020',          brand = 'Mercedes-Benz',  price = 90000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'benzc32',     name = 'Mercedes-Benz C32',              brand = 'Mercedes-Benz',  price = 90000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'c63hr',       name = 'Mercedes C63 HR',                brand = 'Mercedes-Benz',  price = 25000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'A' },
    { model = 'c63scpd',     name = 'Mercedes C63 Patrol',            brand = 'Mercedes-Benz',  price = 32000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'A+' },
    { model = 'e55',         name = 'Mercedes E55',                   brand = 'Mercedes-Benz',  price = 28000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'S' },
    { model = 'e63s',        name = 'Mercedes E63S',                  brand = 'Mercedes-Benz',  price = 70000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'e500',        name = 'Mercedes E500',                  brand = 'Mercedes-Benz',  price = 68000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'mercec63s',   name = 'Mercedes C63S',                  brand = 'Mercedes-Benz',  price = 64000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'rmode63s',    name = 'Mercedes R-Mode E63S',           brand = 'Mercedes-Benz',  price = 62000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'S+' },
    { model = 'w222wald',    name = 'Mercedes S-Class W222 Wald',     brand = 'Mercedes-Benz',  price = 90000,   category = 'mercedes',       type = 'automobile', shop = 'conce', tier = 'S+' },

    -- Nissan
    { model = 'nissantitan17',name = 'Nissan Titan 2017',             brand = 'Nissan',         price = 22000,   category = 'nissan',         type = 'automobile', shop = 'conce', tier = 'A' },
    { model = '350z',        name = 'Nissan 350Z',                    brand = 'Nissan',         price = 26000,   category = 'nissan',         type = 'automobile', shop = 'conce', tier = 'A+' },
    { model = 'gta5rp_veh_gtr33', name = 'Nissan GTR R33',            brand = 'Nissan',         price = 30000,   category = 'nissan',         type = 'automobile', shop = 'conce', tier = 'S+' },

    -- Renault
    { model = 'twingo', name = 'Twingo', brand = 'Renault', price = 6000, category = 'renault', type = 'automobile', shop = 'conce', tier = 'D' },


    -- Motos
    -- Yamaha
    { model = 'aerox155', name = 'Yamaha Aerox 155', brand = 'Yamaha', price = 5000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'D' },
    { model = 'yzfr6', name = 'Yamaha YZF-R6', brand = 'Yamaha', price = 12000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'A' },

    -- Honda
    { model = 'cb650r', name = 'Honda CB650R', brand = 'Honda', price = 7000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'C' },

    -- LCC
    { model = 'claw', name = 'LCC Claw', brand = 'LCC', price = 6000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'B' },

    -- BMW
    { model = 'km1000rr', name = 'BMW S1000RR', brand = 'BMW', price = 20000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'S' },
    { model = 'rr01', name = 'BMW M1000RR', brand = 'BMW', price = 23000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'S' },

    -- MV Agusta
    { model = 'mv2019', name = 'MV Agusta Brutale 1000', brand = 'MV Agusta', price = 25000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'S+' },

    -- Kawasaki
    { model = 'ninjah2', name = 'Kawasaki Ninja H2', brand = 'Kawasaki', price = 30000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'S+' },
    { model = 'zx6r', name = 'Kawasaki Ninja ZX-6R', brand = 'Kawasaki', price = 10000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'B' },
    { model = 'zx10r', name = 'Kawasaki Ninja ZX-10R', brand = 'Kawasaki', price = 18000, category = 'motocicletas', type = 'motorcycle', shop = 'conce', tier = 'A+' },

    -- { model = 'issi2',         name = 'Issi',                          brand = 'Weeny',           price = 7000,    category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'D' },
    -- { model = 'issi3',         name = 'Issi Classic',                  brand = 'Weeny',           price = 5000,    category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'C' },
    -- { model = 'issi4',         name = 'Issi Arena',                    brand = 'Weeny',           price = 80000,   category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'B' },
    -- { model = 'issi5',         name = 'Issi Future Shock',             brand = 'Weeny',           price = 80000,   category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'A' },
    -- { model = 'issi6',         name = 'Issi Nightmare',                brand = 'Weeny',           price = 80000,   category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'A+' },
    ...
    --- Motorcycles (8)
    -- { model = 'akuma',         name = 'Akuma',                         brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'avarus',        name = 'Avarus',                        brand = 'LCC',             price = 20000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'bagger',        name = 'Bagger',                        brand = 'WMC',             price = 13500,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'bati',          name = 'Bati 801',                      brand = 'Pegassi',         price = 24000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'bati2',         name = 'Bati 801RR',                    brand = 'Pegassi',         price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'bf400',         name = 'BF400',                         brand = 'Nagasaki',        price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'carbonrs',      name = 'Carbon RS',                     brand = 'Nagasaki',        price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'chimera',       name = 'Chimera',                       brand = 'Nagasaki',        price = 21000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'cliffhanger',   name = 'Cliffhanger',                   brand = 'Western',         price = 28500,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'daemon',        name = 'Daemon',                        brand = 'WMC',             price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'daemon2',       name = 'Daemon Custom',                 brand = 'Western',         price = 23000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'defiler',       name = 'Defiler',                       brand = 'Shitzu',          price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'deathbike',     name = 'Deathbike Apocalypse',          brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'deathbike2',    name = 'Deathbike Future Shock',        brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'deathbike3',    name = 'Deathbike Nightmare',           brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'diablous',      name = 'Diablous',                      brand = 'Principe',        price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'diablous2',     name = 'Diablous Custom',               brand = 'Principe',        price = 38000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'double',        name = 'Double-T',                      brand = 'Dinka',           price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'enduro',        name = 'Enduro',                        brand = 'Dinka',           price = 5500,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'esskey',        name = 'Esskey',                        brand = 'Pegassi',         price = 12000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'faggio',        name = 'Faggio Sport',                  brand = 'Pegassi',         price = 2000,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'faggio2',       name = 'Faggio',                        brand = 'Pegassi',         price = 1900,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'faggio3',       name = 'Faggio Mod',                    brand = 'Pegassi',         price = 2500,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'fcr',           name = 'FCR 1000',                      brand = 'Pegassi',         price = 5000,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'fcr2',          name = 'FCR 1000 Custom',               brand = 'Pegassi',         price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'gargoyle',      name = 'Gargoyle',                      brand = 'Western',         price = 32000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'hakuchou',      name = 'Hakuchou',                      brand = 'Shitzu',          price = 17000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'hakuchou2',     name = 'Hakuchou Drag',                 brand = 'Shitzu',          price = 45000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'hexer',         name = 'Hexer',                         brand = 'LCC',             price = 16000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'innovation',    name = 'Innovation',                    brand = 'LLC',             price = 33500,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'lectro',        name = 'Lectro',                        brand = 'Principe',        price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'manchez',       name = 'Manchez',                       brand = 'Maibatsu',        price = 8300,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'nemesis',       name = 'Nemesis',                       brand = 'Principe',        price = 20000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'nightblade',    name = 'Nightblade',                    brand = 'WMC',             price = 23000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'oppressor',     name = 'Oppressor',                     brand = 'Pegassi',         price = 9999999, category = 'motorcycles',    type = 'bike',       shop = 'luxury' },
    -- { model = 'pcj',           name = 'PCJ-600',                       brand = 'Shitzu',          price = 15000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'ratbike',       name = 'Rat Bike',                      brand = 'Western',         price = 3000,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'ruffian',       name = 'Ruffian',                       brand = 'Pegassi',         price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'sanchez',       name = 'Sanchez Livery',                brand = 'Maibatsu',        price = 5300,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'sanchez2',      name = 'Sanchez',                       brand = 'Maibatsu',        price = 5300,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'sanctus',       name = 'Sanctus',                       brand = 'LCC',             price = 35000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'shotaro',       name = 'Shotaro',                       brand = 'Nagasaki',        price = 320000,  category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'sovereign',     name = 'Sovereign',                     brand = 'WMC',             price = 8000,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'stryder',       name = 'Stryder',                       brand = 'Nagasaki',        price = 50000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'thrust',        name = 'Thrust',                        brand = 'Dinka',           price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'vader',         name = 'Vader',                         brand = 'Shitzu',          price = 7200,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'vindicator',    name = 'Vindicator',                    brand = 'Dinka',           price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'vortex',        name = 'Vortex',                        brand = 'Pegassi',         price = 31000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'wolfsbane',     name = 'Wolfsbane',                     brand = 'Western',         price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'zombiea',       name = 'Zombie Bobber',                 brand = 'Western',         price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'zombieb',       name = 'Zombie Chopper',                brand = 'Western',         price = 27000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'manchez2',      name = 'Manchez Scout',                 brand = 'Maibatsu',        price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'shinobi',       name = 'Shinobi',                       brand = 'Nagasaki',        price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'reever',        name = 'Reever',                        brand = 'Western',         price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'manchez3',      name = 'Manchez Scout Classic',         brand = 'Maibatsu',        price = 15000,   category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    -- { model = 'powersurge',    name = 'Powersurge',                    brand = 'Western',         price = 7000,    category = 'motorcycles',    type = 'bike',       shop = 'conce' },
    --- Off-Road (9)

...
local Vehicles = {
    ...
    { model = 'blista',        name = 'Blista',                        brand = 'Dinka',           price = 13000,   category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'C'}, -- Can either be D, C, B, A, A+, S, S+ 
    { model = 'brioso',        name = 'Brioso R/A',                    brand = 'Grotti',          price = 20000,   category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'B' },
    { model = 'club',          name = 'Club',                          brand = 'BF',              price = 8000,    category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'A' },
    { model = 'dilettante',    name = 'Dilettante',                    brand = 'Karin',           price = 9000,    category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'A+' },
    { model = 'dilettante2',   name = 'Dilettante Patrol',             brand = 'Karin',           price = 12000,   category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'S' },
    { model = 'kanjo',         name = 'Blista Kanjo',                  brand = 'Dinka',           price = 12000,   category = 'compacts',       type = 'automobile', shop = 'pdm', tier = 'S+' },
